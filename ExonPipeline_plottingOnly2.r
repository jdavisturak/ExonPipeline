...
energyData = read.delim(settings$nucTestFileFixed2_mean,head=F,stringsAsFactors=F)
...
save.image("PlottedData2.RData")
 
load("PlottedData2.RData")
...
png(sprintf('%s_Barplots2.png',settings$CommonName),height=1200,width=300)
...
## SPLIT BY LENGTH
png(sprintf('%s_simple_splitByLength2.png',settings$CommonName),height=1200,width=400)
...
png(sprintf('%s_simple_splitByLengthGroup2.png',settings$CommonName),height=1200,width=400)
par(mfrow=c(3,1),cex.axis=1.2,cex=1.3,cex.main=1.1,las=3,mar=c(6.1 ,4.1 ,4.1, 2.1))
