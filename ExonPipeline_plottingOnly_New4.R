...
energyData = read.delim("exons_forSeqToNuc_constrained_all_norm.txt",head=F,stringsAsFactors=F)
...
save.image("PlottedData_new4.RData")
...
#### 1) Plot Barplots
source("/home/jeremy/ExonPipeline/ExonPipeline_analysis_and_plotting_Functions.r")
pdf(sprintf('%s_Barplots8.pdf',settings$CommonName),height=9,width=2)
...
######################################################
pdf(sprintf('%s_isLast_boxplots4.pdf',settings$CommonName),height=6,width=2)
...
HK = list(0:1,0,1)
  for (h in HK){
    ...
    plot.dev(sprintf('%s_Stability_by_numIntrons_geneSize%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    ...
    plot.dev(sprintf('%s_Stability_by_lengthIntrons_geneSize%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    for(i in 0:1){
    ...
    plot.dev(sprintf('%s_Acceptor_by_numIntrons_geneSize%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    for(i in 0:1){
    ...
    plot.dev(sprintf('%s_Acceptor_by_lengthIntrons_geneSize%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    for(i in 0:1){
    ...
    plot.dev(sprintf('%s_Acceptor_by_geneSize_lengthIntrons%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    for(i in 0:1){
    ...
    plot.dev(sprintf('%s_Acceptor_by_lenIntr_gSize_isLast%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=5)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    ...
    plot.dev(sprintf('%s_Stability_by_lenIntr_gSize_isLast%s4.pdf',settings$CommonName,txt),'pdf',height=3,width=4)
    par(mai=c(.45,.45,0.24,0.1),cex=0.6, cex.main=1)
    AT=c(1:8,10:17,19:26,28:35)
    for(i in 0:1){
...
pdf(sprintf('%s_HK_dataMining4.pdf',settings$CommonName),height=6, width=6)
...
for(column in c('Stability','Acceptor')){
  ...
  pdf(sprintf('%s_%s_new4.pdf',settings$CommonName,column),height=4,width=4*5)  
